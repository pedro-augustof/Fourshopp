...
public class FuncionarioService {
    ...
    public String deleteByCpf(String cpf){
        Funcionario employee = funcionarioRepository.findFuncionarioByCpf(cpf);
        ...
        funcionarioRepository.deleteById(employee.getId());
        enderecoRepository.deleteById(employee.getEndereco().getId());
